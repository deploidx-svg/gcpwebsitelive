      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
            Confused about pricing or website type? Get in touch with us using the form below or chat with our AI consultant.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
          ...
          {/* AI Consultant CTA */}
          <motion.div
            className="relative p-8 sm:p-12 rounded-md overflow-hidden shadow-[0_8px_50px_rgba(0,0,0,0.3)]"
            initial={{ opacity: 0, x: 20 }}
            animate={{ opacity: 1, x: 0 }}
          ...
          >
            ...
            <div className="relative z-10 text-center">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-foreground mb-4">
                Or Talk to Our AI Website Consultant
              </h2>
